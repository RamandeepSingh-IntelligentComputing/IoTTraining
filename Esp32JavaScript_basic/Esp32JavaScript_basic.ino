/*
 *  Hands-on program, demonstrating use of Javascript.   
 *  Aim is to fetch the sensor data at regular interval and display on web browser. 
 *  It stores the webpage on program memory instead of ram.
 */
#include "WiFi.h"
